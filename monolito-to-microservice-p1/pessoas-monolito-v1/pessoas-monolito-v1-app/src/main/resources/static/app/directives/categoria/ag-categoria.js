angular
	.module('diretivas')
	.directive('agCategoria', function($compile) {
	  return {
		restrict     : 'EA',
	    templateUrl  : 'app/directives/categoria/ag-categoria.html',
	    controller   : 'AgCategoriaController',
	    controllerAs : 'agCategoriaController',
