angular
	.module('diretivas')
	.directive('agCategoriaProfissao', function($compile) {
	  return {
		  restrict     : 'EA',
	    templateUrl  : 'app/directives/categoria_profissao/ag-categoria-profissao.html',
	    controller   : 'AgCategoriaProfissaoController',
	    controllerAs : 'agCategoriaProfissaoController',
