angular
	.module('diretivas')
	.directive('agReferenciasol', function($compile) {
	  return {
		restrict     : 'EA',
	    templateUrl  : 'app/directives/referenciasol/ag-referenciasol.html',
	    controller   : 'AgReferenciasolController',
	    controllerAs : 'agReferenciasolController',
